    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="row mt-5">
                    <div class="col-lg-12 text-end container-list p-0">
                        <ul class="ul-menu pt-5">
                            <li onclick="FixHover('riders')" class="hover-li riders" id="riders"><a
                                    class="text-decoration-none" href="{{ route('riders.index') }}">Riders</a></li>
                            <li onclick="FixHover('deliveries')" class="hover-li deliveries" id="deliveries"><a
                                    class="text-decoration-none" href="{{ route('delivery.index') }}">Deliveries</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-10 p-0 ">
                        ...
                        <nav class="nav nav-expand-md d-flex jusitfy-content-center align-items-center">
                            <div>
                                 <h2>Su Stampu delivery system</h2>
                            </div>
                            @auth
                                     
                            <ul class="d-flex d-sm-none align-items-center m-0">
                                <li class="li-register me-3"><a class="text-decoration-none" href="{{ route('riders.index') }}">Riders</a></li>
                                <li class="li-register me-3"><a class="text-decoration-none" href="{{ route('delivery.index') }}">Deliveries</a></li>
                            </ul>
                            <ul class="ul-user">
